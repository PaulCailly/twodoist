					...
					>
						<div class="flex flex-1 items-center md:absolute md:inset-y-0 md:left-0">
							<div class="flex w-full items-center justify-between md:w-auto">
								<a href="#">
									<span class="sr-only">twodo.ist</span>
									<img
			...
			<div class="mx-auto mt-16 max-w-7xl px-4 sm:mt-24 sm:px-6">
				<div class="text-center">
					<h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
						<span class="block">Get things done</span>
						<span class="block text-indigo-600">once and for all</span>
					</h1>
					<p
						class="mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl"
					>
						Become focused, organized, and calm with Twodo.ist.<br />The best task manager and to-do
						list app.
					</p>
				</div>
			</div>
	...
	<div class="bg-gray-800">
		<div class="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
			<h2 class="text-center text-base font-semibold text-gray-400">
				Built with the latest in technology
			</h2>
